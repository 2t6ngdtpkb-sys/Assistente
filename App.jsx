  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          padding: "20px 24px",
          background: "linear-gradient(90deg, rgba(120,80,255,0.3), rgba(80,180,255,0.2))",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div>
              <div style={{ color: "#fff", fontWeight: 700, fontSize: 17, letterSpacing: "-0.3px" }}>{ui.title}</div>
          ...
          <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
            <div style={{ position: "relative" }}>
              ...
              {showLangMenu && (
                <div style={{
                  ...
                  {LANGUAGES.map((l) => (
                    <div key={l.code} onClick={() => { setLang(l.code); setShowLangMenu(false); }} style={{
                      padding: "10px 16px",
                      color: l.code === lang ? "#a78bfa" : "#ccc",
                      cursor: "pointer",
                      fontSize: 13,
            ...
            <button onClick={clearChat} title={ui.clear} style={{
